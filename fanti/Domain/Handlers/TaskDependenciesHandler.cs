...
{
    public class TaskDependenciesHandler : IHandler<CreateTaskDependenciesCommand>, IHandler<UpdateTaskDependenciesCommand>, IHandler<DeleteTaskDependencyCommand>
    {
