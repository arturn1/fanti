...
namespace Infrastructure.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<TaskDependenciesEntity> TaskDependencies { get; set; }        public DbSet<TasksEntity> Tasks { get; set; }
        public DbSet<SprintsEntity> Sprints { get; set; }        public DbSet<ProjectsEntity> Projects { get; set; }
